...
#     Sex,
#     name='sex',
#     create_type=False  # Don't try to create the type with the table
# )
...
# Define these once and reuse across all models to prevent duplicate type creation

sex_enum_type = PGENUM(
    Sex,
    name='sex',
    create_type=False  # Don't auto-create with tables
)
